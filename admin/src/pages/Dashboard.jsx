  ...
  const chartData = useMemo(() => {
    ...
    if (timeFilter === "Monthly") {
      ...
      for (let i = 3; i >= 0; i--) {
        ...
        const weekLabel = `Week ${Math.ceil((weekStart.getDate() + 6) / 7)} ${monthNames[weekStart.getMonth()]}`;
        last4Weeks.push({
          week: weekLabel,
          Completed: 0,
          Cancelled: 0,
    ...
    <div className="w-full max-w-[1400px] mx-auto p-4 sm:p-6 space-y-8 h-[calc(100vh-4rem)] overflow-y-auto scrollbar-thin">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">Welcome to your administration panel</p>
        </div>
